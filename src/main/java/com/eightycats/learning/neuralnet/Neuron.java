...
public class Neuron
{
   ...
   /**
    * The input weights. inputs[n] is multiplied by weights[n] 
    * to get the weighted input value.
    */
   private double[] weights;

   /**
    * The most recent weight adjustments. These values are
    * used in calulating momentum when training a network.
    */
   ...
   /**
    * Randomizes the weight values within the given range. By default,
    * weights are within the range of -0.4 and 0.4.
    *
    * @param minWeight double a minimum weight value between -1.0 and 1.0.
    * @param maxWeight double a maximum weight value between -1.0 and 1.0.
    */
   ...
   /**
    * This multiplies each of the input values
    * by its respective weight and sums the
    * results. This total is the weighted stimulation
    * for the given input pattern.
    *
    * @param inputs double[] an array of input values. The number
    *                        of inputs should match the number of weights.
